...
class CustomTaxonomyController extends BaseController
{
	...
	public function setSubpages()
	{
		$this->subpages = array(
			array(
				'parent_slug' => 'abdat_plugin', 
				'page_title' => 'Custom Taxonomies', 
				'menu_title' => 'Taxonomy Manager', 
				'capability' => 'manage_options', 
				'menu_slug' => 'abdat_taxonomy', 
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'abdat_plugin_tax_settings',
				'option_name' => 'abdat_plugin_tax',
	...
	{
		$options = get_option( 'abdat_plugin_tax' ) ?: array();
